...
ActiveRecord::Schema.define(version: 2020_02_04_163727) do
  ...
  create_table "locations", force: :cascade do |t|
    ...
    t.index ["dealership_id"], name: "index_locations_on_dealership_id"
  end

  add_foreign_key "dealerships", "cities"
  add_foreign_key "locations", "cities"
  add_foreign_key "locations", "dealerships"
end
